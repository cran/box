...
- ‘**[import](https://import.rticulate.org/)**’: Alternative mechanism
  ...
  for importing multiple objects with a single command in an expressive
  way. The import package bridges some of the gap between using library
  (or require) and direct (single-object) imports. Furthermore the
